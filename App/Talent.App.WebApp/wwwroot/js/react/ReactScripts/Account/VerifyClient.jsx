...
export default class VerifyClient extends React.Component {
    ...
    checkToken(recruiterEmail, clientEmail, resetPasswordToken) {
        ...
        //var link = 'http://authapitalent.azurewebsites.net/';//http://localhost:60998/
        var link = 'http://localhost:60998/'

        let url = `${link}authentication/authentication/verifyClientToken?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
        $.ajax({
            url: url,
            type: 'POST',
    ...
    savePassword() {
        ...
        let resetUrl = `${link}authentication/authentication/validateInvitation?recruiterEmail=${recruiterEmail}&clientEmail=${clientEmail}&resetPasswordToken=${resetPasswordToken}`;
