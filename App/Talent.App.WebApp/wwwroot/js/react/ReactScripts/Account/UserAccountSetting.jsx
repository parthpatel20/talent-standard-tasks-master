...
export default class UserAccountSetting extends React.Component {
    ...
    save(e, field) {
        ...
        if (field == "name") {
            $.ajax({
                url: link + 'authentication/authentication/changeUserName?userName=' + this.state.userName,
                type: 'POST',
                headers: {
        ...
        if (field == "password") {
            ...
            var link = 'http://authapitalent.azurewebsites.net/';//http://localhost:60998/
            $.ajax({
                url: link + 'authentication/authentication/changePassword',
                type: "POST",
        ...
        if (field == "deactivate") {
            ...
            $.ajax({
                url: link + 'authentication/authentication/deactivateAccount',
                type: "POST",
                headers: {
                    'Authorization': 'Bearer ' + cookies,
                    'Content-Type': 'application/json; charset=utf-8'
    ...
    getUserRole() {
        ...
        var link = 'http://authapitalent.azurewebsites.net/';//http://localhost:60998/
        $.ajax({
            url: link + 'authentication/authentication/getAccountSettingInfo',
            type: 'GET',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json; charset=utf-8'
