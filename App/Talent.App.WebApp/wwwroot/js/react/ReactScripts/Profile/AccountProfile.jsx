...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        $.ajax({
            url: link + 'profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile() {
        ...
        $.ajax({
            url: link + 'profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
    ...
    render() {
        ...
        //const link = 'http://profileapitalent.azurewebsites.net/profile/profile/updateProfilePhoto';
        const link = "http://localhost:60290/profile/profile/updateProfilePhoto";
                            ...
                            <div className="profile">
                                <form className="ui form">
                                    <div className="ui grid">
                                        ...
                                        <FormItemWrapper
                                            title='Description'
                                            tooltip='Tell us somthing about your self'
                                        >
                                            <SelfIntroduction
